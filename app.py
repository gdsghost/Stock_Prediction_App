    ...
    [
        html.Div(
            [
                ...
                html.P("(By Sudam Yasodya)", className="copyright"),
                html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "This is a simple dash app which produces dynamic plots of the closing prices and exponential moving average of user input stock code. In addition to that, the app used a machine learning model (SVR) to give prediction of the closing stock price for the number of user input days.", "https://images.pexels.com/photos/210607/pexels-photo-210607.jpeg", "Stock Details & Predictions", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
